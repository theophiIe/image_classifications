...
tf.saved_model.save(model_tensorflow_1, 'saved_models/model_tensorflow_1')
tf.saved_model.save(model_google_4, 'saved_models/model_google_4')
tf.saved_model.save(model_google_5, 'saved_models/model_google_5')
tf.saved_model.save(model_google_6, 'saved_models/model_google_6')
